 ...
 * and manages the session by storing both the account information and the specific shipper ID.
 * 
 * <p>Request format:
 * <pre>
 * {
...
public class ShipperLoginServlet extends HttpServlet {
    ...
    /**
     * Handles POST requests for shipper login.
     * 
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (user != null) {
            ...
            if (!roles.SHIPPER.equals(user.getVaiTro())) {
                ...
                // 5. Session Enrichment: Fetch and store the role-specific shipperId
                // This allows other servlets to easily access the shipper's primary key
