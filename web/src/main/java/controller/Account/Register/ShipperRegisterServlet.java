...
/**
 * Servlet handling registration requests for Shipper accounts.
 * This servlet processes POST requests containing shipper details in JSON format.
 * It hashes the password, validates the input, and persists the new shipper account 
 ...
 * </p>
 */
@WebServlet("/api/shipper/register")
public class ShipperRegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Attempt to register the new shipper
        boolean success = tkdao.registerShipper(email, hashedPassword, name, birthday, SDT);
