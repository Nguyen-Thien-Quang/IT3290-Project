...
public class GioHangServlet extends HttpServlet {
    ...
    // POST /api/cart thêm món ăn vào giỏ hàng, MonAnID và số lượng sẽ có trong request body
    // DELETE: xóa món ăn khỏi giỏ hàng, MonAnID lấy từ path param
    // PUT: update giỏ hàng, MonAnID và quantity sẽ lấy từ body request
